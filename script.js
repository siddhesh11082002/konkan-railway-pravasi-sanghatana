document.addEventListener('DOMContentLoaded', function() {
  ...
  buttons.forEach((button, index) => {
    ...
    document.getElementById('sendEmailBtn').addEventListener('click', function() {
        var recipients = "ashwini.vaishnav@gmail.com,moeitoffice@gmail.com,vsomannavijayanagara@gmail.com,ravneetbittu@gmail.com,connect@mygov.nic.in,response@nitingadkari.org.in,piyushgoyalofficial@gmail.com,narayan.rane@gov.in,narayanrane52@gmail.com,narayan.rane@sansad.nic.in";
        var cc = "cm@maharashtra.gov.in,eknathshindeonline@gmail.com,cmpro@maharashtra.gov.in,dcm@maharashtra.gov.in,devendrafadnavis@yahoo.com,kesarkardeepak@gmail.com,udaysamant11@gmail.com,niranjanvdavkhare@gmail.com,drshrikanteknathshinde@gmail.com,cmd@krcl.co.in,gm@cr.railnet.gov.in,sm.haryan@krcl.co.in,secy.cmd@krcl.co.in,secgm@cr.railnet.gov.in,rrmrn@krcl.co.in,cpro@cr.railnet.gov.in";
        ...
        // Programmatically click the link to open the user's default email client
        tempLink.click();
